...
$(error You must specify miniascape_NETWORK_1, that is, single network interface is needed for a VM at least.)
endif

miniascape_NET_1_MODEL	?= $(miniascape_NET_MODEL_DEFAULT)
miniascape_MAC_1	?= $(miniascape_NET_MAC_DEFAULT)
...
miniascape_MAC_2	?= $(miniascape_NET_MAC_DEFAULT)
...
miniascape_MAC_3	?= $(miniascape_NET_MAC_DEFAULT)
...
miniascape_MAC_4	?= $(miniascape_NET_MAC_DEFAULT)
